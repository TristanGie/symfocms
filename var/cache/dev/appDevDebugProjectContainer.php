...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '1_750b94296a08a37f3eff759d6f3f1aaf6e4e8eecbfc79bd1ef227a43151e6492' => 'get1750b94296a08a37f3eff759d6f3f1aaf6e4e8eecbfc79bd1ef227a43151e6492Service',
            '2_750b94296a08a37f3eff759d6f3f1aaf6e4e8eecbfc79bd1ef227a43151e6492' => 'get2750b94296a08a37f3eff759d6f3f1aaf6e4e8eecbfc79bd1ef227a43151e6492Service',
        ...
        $this->privates = array(
            '1_750b94296a08a37f3eff759d6f3f1aaf6e4e8eecbfc79bd1ef227a43151e6492' => true,
            '2_750b94296a08a37f3eff759d6f3f1aaf6e4e8eecbfc79bd1ef227a43151e6492' => true,
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = ${($_ = isset($this->services['doctrine_phpcr']) ? $this->services['doctrine_phpcr'] : $this->get('doctrine_phpcr')) && false ?: '_'};
        ...
        })), $d, array()), 6 => new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheWarmer($this, new \Symfony\Bundle\TwigBundle\TemplateIterator($a, ($this->targetDirs[3].'/app'), array())), 7 => new \Symfony\Bridge\Doctrine\CacheWarmer\ProxyCacheWarmer($c), 8 => new \Doctrine\Bundle\PHPCRBundle\CacheWarmer\UniqueNodeTypeCacheWarmer($c)));
    }
    ...
    protected function getConfigCacheFactoryService()
    {
        return $this->services['config_cache_factory'] = new \Symfony\Component\Config\ResourceCheckerConfigCacheFactory(new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['1_750b94296a08a37f3eff759d6f3f1aaf6e4e8eecbfc79bd1ef227a43151e6492']) ? $this->services['1_750b94296a08a37f3eff759d6f3f1aaf6e4e8eecbfc79bd1ef227a43151e6492'] : $this->get1750b94296a08a37f3eff759d6f3f1aaf6e4e8eecbfc79bd1ef227a43151e6492Service()) && false ?: '_'};
            yield 1 => ${($_ = isset($this->services['2_750b94296a08a37f3eff759d6f3f1aaf6e4e8eecbfc79bd1ef227a43151e6492']) ? $this->services['2_750b94296a08a37f3eff759d6f3f1aaf6e4e8eecbfc79bd1ef227a43151e6492'] : $this->get2750b94296a08a37f3eff759d6f3f1aaf6e4e8eecbfc79bd1ef227a43151e6492Service()) && false ?: '_'};
        }, 2));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->get('doctrine.dbal.connection_factory')) && false ?: '_'}->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'symfonycmf', 'user' => 'test', 'password' => 'test', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    /**
     * Gets the public 'doctrine_phpcr.odm.default.translation.strategy.attribute' shared service.
     *
     * @return \Doctrine\ODM\PHPCR\Translation\TranslationStrategy\AttributeTranslationStrategy
     */
    protected function getDoctrinePhpcr_Odm_Default_Translation_Strategy_AttributeService()
    {
        $this->services['doctrine_phpcr.odm.default.translation.strategy.attribute'] = $instance = new \Doctrine\ODM\PHPCR\Translation\TranslationStrategy\AttributeTranslationStrategy(${($_ = isset($this->services['doctrine_phpcr.odm.default_document_manager']) ? $this->services['doctrine_phpcr.odm.default_document_manager'] : $this->get('doctrine_phpcr.odm.default_document_manager')) && false ?: '_'});
    ...
    /**
     * Gets the public 'doctrine_phpcr.odm.default.translation.strategy.child' shared service.
     *
     * @return \Doctrine\ODM\PHPCR\Translation\TranslationStrategy\ChildTranslationStrategy
     */
    protected function getDoctrinePhpcr_Odm_Default_Translation_Strategy_ChildService()
    {
        return $this->services['doctrine_phpcr.odm.default.translation.strategy.child'] = new \Doctrine\ODM\PHPCR\Translation\TranslationStrategy\ChildTranslationStrategy(${($_ = isset($this->services['doctrine_phpcr.odm.default_document_manager']) ? $this->services['doctrine_phpcr.odm.default_document_manager'] : $this->get('doctrine_phpcr.odm.default_document_manager')) && false ?: '_'});
    }

    /**
     * Gets the public 'doctrine_phpcr.odm.default_document_manager' shared service.
     *
    ...
    protected function getDoctrinePhpcr_Odm_DefaultDocumentManagerService()
    {
        ...
        $a->setNamespace('sf_phpcr_default_ccf1ed3be2149076975a4d92645d721f3230b5dec8f9a327cbb4951505411810');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver(new \Doctrine\ODM\PHPCR\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->get('annotation_reader')) && false ?: '_'}, array(0 => ($this->targetDirs[3].'/vendor/doctrine/phpcr-odm/lib/Doctrine/ODM/PHPCR/Document'))), 'Doctrine\\ODM\\PHPCR\\Document');
        ...
        $this->services['doctrine_phpcr.odm.default_document_manager'] = $instance = new \Doctrine\ODM\PHPCR\DocumentManager(${($_ = isset($this->services['doctrine_phpcr.default_session']) ? $this->services['doctrine_phpcr.default_session'] : $this->get('doctrine_phpcr.default_session')) && false ?: '_'}, $c, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this));

        $instance->setTranslationStrategy('child', ${($_ = isset($this->services['doctrine_phpcr.odm.default.translation.strategy.child']) ? $this->services['doctrine_phpcr.odm.default.translation.strategy.child'] : $this->get('doctrine_phpcr.odm.default.translation.strategy.child')) && false ?: '_'});
        $instance->setTranslationStrategy('attribute', ${($_ = isset($this->services['doctrine_phpcr.odm.default.translation.strategy.attribute']) ? $this->services['doctrine_phpcr.odm.default.translation.strategy.attribute'] : $this->get('doctrine_phpcr.odm.default.translation.strategy.attribute')) && false ?: '_'});

        return $instance;
    }

    /**
     * Gets the public 'doctrine_phpcr.odm.form.type.path' shared service.
     *
     * @return \Doctrine\Bundle\PHPCRBundle\Form\Type\PathType
     */
    protected function getDoctrinePhpcr_Odm_Form_Type_PathService()
    {
        return $this->services['doctrine_phpcr.odm.form.type.path'] = new \Doctrine\Bundle\PHPCRBundle\Form\Type\PathType(${($_ = isset($this->services['doctrine_phpcr']) ? $this->services['doctrine_phpcr'] : $this->get('doctrine_phpcr')) && false ?: '_'});
    }

    /**
     * Gets the public 'doctrine_phpcr.odm.translation.strategy.attribute' shared service.
     *
     * @return \Doctrine\ODM\PHPCR\Translation\TranslationStrategy\AttributeTranslationStrategy
     */
    ...
    /**
     * Gets the public 'doctrine_phpcr.odm.translation.strategy.child' shared service.
     *
     * @return \Doctrine\ODM\PHPCR\Translation\TranslationStrategy\ChildTranslationStrategy
     */
    ...
    /**
     * Gets the public 'doctrine_phpcr.odm.validator.valid_phpcr_odm' shared service.
     *
     * @return \Doctrine\Bundle\PHPCRBundle\Validator\Constraints\ValidPhpcrOdmValidator
     */
    protected function getDoctrinePhpcr_Odm_Validator_ValidPhpcrOdmService()
    {
        return $this->services['doctrine_phpcr.odm.validator.valid_phpcr_odm'] = new \Doctrine\Bundle\PHPCRBundle\Validator\Constraints\ValidPhpcrOdmValidator(${($_ = isset($this->services['doctrine_phpcr']) ? $this->services['doctrine_phpcr'] : $this->get('doctrine_phpcr')) && false ?: '_'});
    }
    ...
    protected function getForm_RegistryService()
    {
        return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('Doctrine\\Bundle\\PHPCRBundle\\Form\\Type\\PHPCRReferenceType' => function () {
        ...
        }, 'Doctrine\\Bundle\\PHPCRBundle\\Form\\Type\\PathType' => function () {
            return ${($_ = isset($this->services['doctrine_phpcr.odm.form.type.path']) ? $this->services['doctrine_phpcr.odm.form.type.path'] : $this->get('doctrine_phpcr.odm.form.type.path')) && false ?: '_'};
        }, 'Doctrine\\Bundle\\PHPCRBundle\\Form\\Type\\DocumentType' => function () {
            return ${($_ = isset($this->services['form.type.phpcr.document']) ? $this->services['form.type.phpcr.document'] : $this->get('form.type.phpcr.document')) && false ?: '_'};
        }, 'Doctrine\\Bundle\\PHPCRBundle\\Form\\Type\\PHPCRODMReferenceCollectionType' => function () {
            return ${($_ = isset($this->services['form.type.phpcr_odm.reference_collection']) ? $this->services['form.type.phpcr_odm.reference_collection'] : $this->get('form.type.phpcr_odm.reference_collection')) && false ?: '_'};
            ...
            yield 1 => ${($_ = isset($this->services['form.type_guesser.doctrine_phpcr']) ? $this->services['form.type_guesser.doctrine_phpcr'] : $this->get('form.type_guesser.doctrine_phpcr')) && false ?: '_'};
    ...
    /**
     * Gets the public 'form.type.phpcr.document' shared service.
     *
     * @return \Doctrine\Bundle\PHPCRBundle\Form\Type\DocumentType
     */
    protected function getForm_Type_Phpcr_DocumentService()
    {
        return $this->services['form.type.phpcr.document'] = new \Doctrine\Bundle\PHPCRBundle\Form\Type\DocumentType(${($_ = isset($this->services['doctrine_phpcr']) ? $this->services['doctrine_phpcr'] : $this->get('doctrine_phpcr')) && false ?: '_'});
    }
    ...
    {
        return $this->services['form.type.phpcr.reference'] = new \Doctrine\Bundle\PHPCRBundle\Form\Type\PHPCRReferenceType(${($_ = isset($this->services['doctrine_phpcr.default_session']) ? $this->services['doctrine_phpcr.default_session'] : $this->get('doctrine_phpcr.default_session')) && false ?: '_'});
    }

    /**
     * Gets the public 'form.type.phpcr_odm.reference_collection' shared service.
     *
     * @return \Doctrine\Bundle\PHPCRBundle\Form\Type\PHPCRODMReferenceCollectionType
     */
    protected function getForm_Type_PhpcrOdm_ReferenceCollectionService()
    {
        return $this->services['form.type.phpcr_odm.reference_collection'] = new \Doctrine\Bundle\PHPCRBundle\Form\Type\PHPCRODMReferenceCollectionType(${($_ = isset($this->services['doctrine_phpcr.odm.default_document_manager']) ? $this->services['doctrine_phpcr.odm.default_document_manager'] : $this->get('doctrine_phpcr.odm.default_document_manager')) && false ?: '_'});
    }
    ...
    /**
     * Gets the public 'form.type_guesser.doctrine_phpcr' shared service.
     *
     * @return \Doctrine\Bundle\PHPCRBundle\Form\PhpcrOdmTypeGuesser
     */
    protected function getForm_TypeGuesser_DoctrinePhpcrService()
    {
        return $this->services['form.type_guesser.doctrine_phpcr'] = new \Doctrine\Bundle\PHPCRBundle\Form\PhpcrOdmTypeGuesser(${($_ = isset($this->services['doctrine_phpcr']) ? $this->services['doctrine_phpcr'] : $this->get('doctrine_phpcr')) && false ?: '_'}, array());
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->setConstraintValidatorFactory(new \Symfony\Component\Validator\ContainerConstraintValidatorFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('Doctrine\\Bundle\\PHPCRBundle\\Validator\\Constraints\\ValidPhpcrOdmValidator' => function () {
            return ${($_ = isset($this->services['doctrine_phpcr.odm.validator.valid_phpcr_odm']) ? $this->services['doctrine_phpcr.odm.validator.valid_phpcr_odm'] : $this->get('doctrine_phpcr.odm.validator.valid_phpcr_odm')) && false ?: '_'};
        ...
        }, 'doctrine_phpcr.odm.validator.valid_phpcr_odm' => function () {
            return ${($_ = isset($this->services['doctrine_phpcr.odm.validator.valid_phpcr_odm']) ? $this->services['doctrine_phpcr.odm.validator.valid_phpcr_odm'] : $this->get('doctrine_phpcr.odm.validator.valid_phpcr_odm')) && false ?: '_'};
    ...
    /**
     * Gets the private '1_750b94296a08a37f3eff759d6f3f1aaf6e4e8eecbfc79bd1ef227a43151e6492' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker
     */
    protected function get1750b94296a08a37f3eff759d6f3f1aaf6e4e8eecbfc79bd1ef227a43151e6492Service()
    {
        return $this->services['1_750b94296a08a37f3eff759d6f3f1aaf6e4e8eecbfc79bd1ef227a43151e6492'] = new \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker($this);
    }

    /**
     * Gets the private '2_750b94296a08a37f3eff759d6f3f1aaf6e4e8eecbfc79bd1ef227a43151e6492' shared service.
     *
     * @return \Symfony\Component\Config\Resource\SelfCheckingResourceChecker
     */
    protected function get2750b94296a08a37f3eff759d6f3f1aaf6e4e8eecbfc79bd1ef227a43151e6492Service()
    {
        return $this->services['2_750b94296a08a37f3eff759d6f3f1aaf6e4e8eecbfc79bd1ef227a43151e6492'] = new \Symfony\Component\Config\Resource\SelfCheckingResourceChecker();
    }
    ...
    {
        $this->services['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('wFbuJSUfeN', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('A6aiyWtuT9', 0, 'S7RPkYGKc1jZ5Lo+WsYe0a', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('y19kUtQn0L', 0, 'S7RPkYGKc1jZ5Lo+WsYe0a', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('SlC8VBd+1l', 0, 'S7RPkYGKc1jZ5Lo+WsYe0a', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('59cd1de91e7410.45820910');
    }
